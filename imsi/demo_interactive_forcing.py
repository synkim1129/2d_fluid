...
vobs_file='/home/teamai/data/241014/just/u_v_shifted.nc'
with nc.Dataset(vobs_file, 'r') as ds:
    v_obs_adj = ds.variables['v_shifted'][:4100]
    u_obs_adj = ds.variables['u_shifted'][:4100]
...
nc_file_v_new = '/home/teamai/data/241014/shift/v_new_data.nc'
