...
nc_file_v_new = '/home/teamai/data/expname/just/v_new_data.nc'
...
with torch.no_grad():
    while True:
        ...
        for t in range(n_time_steps):
            ...
            a_new,p_new = fluid_model(a_old,p_old,flow_mask,v_cond,cond_mask,v_obs[np.newaxis,:],obs_mask[np.newaxis,:])
            v_new = rot_mac(a_new)
