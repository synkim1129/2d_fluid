...
#nc_file_v_new = '/home/teamai/data/20p/before/v_new_data.nc'
nc_file_v_new = '/home/teamai/data/600ball.nc'
...
with torch.no_grad():
	while True:
		...
		dataset = Dataset(w,h,1,1,interactive=True,average_sequence_length=n_time_steps,max_speed=params.max_speed,dt=dt,types=["fixed_ball"],images=["fish"],background_images=["empty"])
