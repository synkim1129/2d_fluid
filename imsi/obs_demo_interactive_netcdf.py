...
date_time,index = logger.load_state(fluid_model,None,direct_path='./Logger/net UNet2; hs 20; mu 1.7894e-05; rho 1.225; dt 4.0;/2024-10-14 16:52:30/states/90.state')
fluid_model.eval()
...
#nc_file_v_new = '/data/binpyo/240725/before/v_new_data.nc'
#nc_file_v_new = '/data/binpyo/before/240718/v_new_data.nc'
nc_file_v_new = './obs_data/before/v_new_data.nc'
...
with torch.no_grad():
	while True:
		...
		dataset = Dataset(w,h,1,1,interactive=True,average_sequence_length=n_time_steps,max_speed=params.max_speed,dt=dt,types=["fixed_box"],images=["fish"],background_images=["empty"])
