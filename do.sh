...
# 수정된 파일 실행
CUDA_VISIBLE_DEVICES=1  python $forcexp_FILE --mu=1.7894e-05 --rho=1.225 --dt=4 --load_index=$loadindex --load_date_time=2024-11-19\ 18:26:48 --average_sequence_length=30000 --n_forcing=10
