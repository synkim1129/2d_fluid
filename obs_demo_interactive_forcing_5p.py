...
vobs_file='/home/teamai/data/241014/10p/just/u_v_shifted.nc'
with nc.Dataset(vobs_file, 'r') as ds:
    v_obs_adj = ds.variables['v_shifted'][:50000]
    u_obs_adj = ds.variables['u_shifted'][:50000]
...
x_obs = [200,200,175,175,150,150,120,120,100,100]
...
nc_file_v_new = '/home/teamai/data/241014/10p/shift/v_new_data.nc'
